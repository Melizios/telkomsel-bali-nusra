			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php echo site_url('admin/pesanan/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label for="nomeja">nomeja*</label>
								<input class="form-control <?php echo form_error('nomeja') ? 'is-invalid':'' ?>"
								 type="text" name="Nomor Meja" placeholder="Nomor Meja" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('Stock') ? 'is-invalid':'' ?>"
								 type="number" name="Stock" min="0" placeholder="Jumlah" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('makan') ? 'is-invalid':'' ?>"
								 type="text" name="Makanan" placeholder="makan" />
								<div class="invalid-feedback">
